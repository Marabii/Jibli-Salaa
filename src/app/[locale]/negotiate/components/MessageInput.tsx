...
export default function MessageInput({
  ...
  const t = useTranslations("Negotiate.Components.MessageInput");
  ...
  return (
    <div className="flex h-[40px] mt-4 w-full">
      ...
      <motion.button
        onClick={handleSend}
        className="bg-white cursor-pointer text-black flex items-center justify-center rounded-r-lg hover:bg-gray-300 transition-colors w-10 sm:w-12 md:w-14 h-full"
        whileTap={{ scale: 0.95 }}
